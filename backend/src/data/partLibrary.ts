...
export const PARTS: PartSpec[] = [
  ...
  },
  {
    ...
    currentTypMa: 0.5,
    currentMaxMa: 1.0,
    notes: ['Rotary / slide potentiometer analog voltage divider.'],
  },
  {
    id: 'generic-photoresistor',
    family: 'PHOTORESISTOR',
    manufacturer: 'Generic',
    kind: 'sensor',
    supplyMinV: 3.3,
    supplyMaxV: 5.0,
    currentTypMa: 1.0,
    currentMaxMa: 2.0,
    notes: ['Cadmium Sulfide (CdS) LDR light sensor module.'],
  },
  {
    id: 'generic-buzzer',
    family: 'BUZZER',
    ...
    currentTypMa: 15,
    currentMaxMa: 30,
    notes: ['Piezo / magnetic buzzer for audible alerts.'],
  },
  {
    id: 'generic-pushbutton',
    family: 'PUSHBUTTON',
    manufacturer: 'Generic',
    kind: 'other',
    supplyMinV: 0,
    ...
    currentTypMa: 0.1,
    currentMaxMa: 0.5,
    notes: ['Tactile momentary pushbutton.'],
  },
  {
    id: 'generic-neopixel',
    family: 'WS2812B',
    ...
    currentTypMa: 20,
    currentMaxMa: 60,
    notes: ['Addressable RGB LED (WS2812B). Up to 60 mA per pixel at full white.'],
  },
];
